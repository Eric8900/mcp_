...
export const Navbar = ({ children, className, fixed }: NavbarProps) => {
  ...
  return (
    <motion.div
      ...
      className={cn(fixed ? "fixed" : "relative", "inset-x-0 top-5 z-40 w-full", className)}
    >
